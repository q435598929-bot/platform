...
public class V2TradePaymentJspayTask {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 商品描述
        request.setGoodsDesc(TaskArguments.value(pageInputs, "goods_desc", "hibs自动化-通用版验证"));
        // 交易类型
        request.setTradeType(TaskArguments.value(pageInputs, "trade_type", "A_NATIVE"));
        // 交易金额
        request.setTransAmt(TaskArguments.value(pageInputs, "trans_amt", "0.10"));
