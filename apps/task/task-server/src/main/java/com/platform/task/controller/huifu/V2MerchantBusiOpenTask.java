...
public class V2MerchantBusiOpenTask {
    public static final String PAY_CHANNEL_ID = "00000044";
    ...
    public static void main(String[] args) throws Exception {
        ...
        request.setHuifuId(TaskArguments.value(pageInputs, "huifu_id", HuifuConfig.HUIFU_ID));
        request.setUpperHuifuId(TaskArguments.value(pageInputs, "upper_huifu_id", HuifuConfig.UPPER_HUIFU_ID));
        Map<String, Object> extendInfoMap = getExtendInfos();
        request.setExtendInfo(extendInfoMap);

        Map<String, Object> response = BasePayClient.request(request, false);
        System.out.println("微信配置开通返回: " + JSONObject.toJSONString(response));
    ...
    private static MerConfig getMerConfig() {
        ...
        merConfig.setProductId(HuifuConfig.PRODUCT_ID);
        merConfig.setSysId(HuifuConfig.SYS_ID);
        merConfig.setRsaPrivateKey(HuifuConfig.RSA_PRIVATE_KEY);
        merConfig.setRsaPublicKey(HuifuConfig.RSA_PUBLIC_KEY);
        return merConfig;
    }
    ...
    private static String getAliConfList() {
        ...
        dto.put("pay_scene", "1");
        // 手续费（%）
        dto.put("fee_rate", "0.23");
        // 商户经营类目
        // dto.put("mcc", "2015091000052157");
        // 子渠道号
        dto.put("pay_channel_id", PAY_CHANNEL_ID);
        // 拟申请的间联商户等级
